...
import org.charlesStockman.designPatterns.creation.BuildFluentRecursiveGenerics.Solution.PersonBuilderRecursiveGenerics;
 ...
 */
public class TestPersonBuilderRecursiveGenerics {

    @Test
    public void testWithNameAsNull() {
        PersonBuilderRecursiveGenerics personBuilder = new PersonBuilderRecursiveGenerics();
    ...
    public void TestCreateFunction() throws IllegalAccessException {
        String name = "Charles Stockman";
        GenderEnum.Gender gender = GenderEnum.Gender.Male;
        ...
        Assertions.assertEquals(person.getGender(), gender,
                String.format("PersonBuilder created a person with the gender of %s instead of %s", person.getGender().name(), gender.name()));
